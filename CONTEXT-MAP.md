...
| SBOR | `packages/sbor/CONTEXT.md` | Working on programmatic SBOR decoding/encoding, schema builders, Scrypto value representations, or Effect Schema integration for SBOR values. |
