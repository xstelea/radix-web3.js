...
describe('sbor', () => {
      ...
      updates: [
        [
          'XRP/USD',
          {
            ...
            funding_long_index: '-11043086051690144.381798536004162019',
  ...
  it('parse a multi-layered structure of doom', () => {
    ...
    const result = evaluateResultHelper(schema, example, expectedParsedValue);
    expectTypeOf(result).toEqualTypeOf<expectedType>();
  });
    ...
    const example: ProgrammaticScryptoSborValue = {
      ...
      fields: [
        ...
        },
        {
          ...
          value:
            'internal_vault_rdx1trk0j6gasw0a0a8vm8reegfm2arj27rapmffjxdjzfsg23vctmuapn',
        },
        {
          kind: 'Own',
          type_name: 'Vault',
          field_name: 'x_fees',
          value:
            'internal_vault_rdx1trgsrylgw9uj8atmepytjtxder25kawa70dq3fgcctp6hy85lcjq46',
        },
        {
          kind: 'Own',
          type_name: 'Vault',
          field_name: 'y_fees',
          value:
            'internal_vault_rdx1trt36r2ypsa2d6nkv6m3ynwhfvduqyj69wwp0f0ac9ax2ykl3uq7ue',
        },
        {
          kind: 'U32',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              field_name: 'store',
              value:
                'internal_keyvaluestore_rdx1kplayw0a626grcr6whuxzsw84stykvh9cp0znadg5adxjxmafl3zf3',
            },
            {
              kind: 'Map',
        ...
        },
        {
          ...
          field_name: 'registry',
          value:
            'component_rdx1crdy3ut4f78nxjpum37kl0682nq0vee9ntwrz8eg7mtxe8kyanwjmv',
        },
        {
          kind: 'U64',
        ...
        },
        {
          ...
          value:
            'internal_vault_rdx1tqksgqvrhnhtl599fv4d5pd93xmadptxslkw8uyn6zzq6dke45xdt4',
        },
        {
          kind: 'Own',
          type_name: 'Vault',
          ...
          value:
            'internal_vault_rdx1tz8yuffczg9zmkkjaut0hr5zel7n5rehqne7xcalwf0knl5dlr59p6',
        },
        {
          kind: 'U64',
        ...
        },
        {
          ...
          value:
            'resource_rdx1nfy368dkh3emwtplg4vpgrpyvpcch0sezytp93fea0zjqup9tj2z3u',
        },
        {
          kind: 'Decimal',
          ...
          fields: [
            {
              ...
              value:
                'internal_keyvaluestore_rdx1krzv59c6nn43y8zmp3j0kmqdmxfep2vgjs0cj09al0l6zrm5tlvj4d',
            },
            {
              kind: 'Enum',
              type_name: 'Option',
